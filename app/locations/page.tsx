                ...
                <div className="bg-[#1e1e2d] p-4 border-t border-violet-900/30">
                  <div className="flex items-start justify-between">
                    ...
                    <Link
                      ...
                      onClick={() => fetch('/api/activity', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ action: 'view_location', details: { locationName: selectedPlace.name, address: selectedPlace.address, city: selectedPlace.city, category: selectedPlace.category, placeId: selectedPlace.placeId || selectedPlace.id, source: 'view_details_button' } }) }).catch(() => {})}
                    >
                      View Details
                    </Link>
                  </div>
